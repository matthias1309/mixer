...
export function IngredientMasterForm({ initialData, isEditing = false }: IngredientMasterFormProps) {
  ...
  const nutrientInputs = [
    ...
    { label: 'Carbohydrates', value: carbohydrates, onChange: setCarbohydrates, unit: 'g' },
    { label: 'Sugar', value: sugar, onChange: setSugar, unit: 'g' },
    { label: 'Fiber', value: fiber, onChange: setFiber, unit: 'g' },
    { label: 'Sodium', value: sodium, onChange: setSodium, unit: 'mg' },
